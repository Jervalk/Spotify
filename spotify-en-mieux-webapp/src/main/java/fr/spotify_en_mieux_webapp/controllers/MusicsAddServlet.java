 ...
 */
@WebServlet({"/musics/add"})
@MultipartConfig
public class MusicsAddServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		this.getServletContext().getRequestDispatcher("/WEB-INF/jsp/pages/musicsAdd.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (file != null && file.getSize() > 0) {
			// TODO: compute duration from file
